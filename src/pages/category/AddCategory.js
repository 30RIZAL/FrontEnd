...
import { doCreateRecaStarted } from '../../redux/actions/Reca'
...
function AddCategory(props) {
    ...
    const onSubmit = async () => {
        const data = {
            reca_name: (values.reca_name).toUpperCase() || '',
                                ...
                                <form action="#" method="POST">
                                    <div className="col-span-6 sm:col-span-3">
                                        ...
                                        <input
                                            ...
                                            name="reca_name"
                                            id='reca_name'
                                            value={values.reca_name}
                                            onChange={handleChange('reca_name')}
...
const mapDispatchToProps = (dispatch) => ({
    setCategory: payload => dispatch(doCreateRecaStarted(payload))
})
